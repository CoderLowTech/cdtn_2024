...
class UserManage extends Component {
    ...
    toggleEditModal = () => {
        this.setState({
            isModalEditUserOpened: !this.state.isModalEditUserOpened
        })
    }
    ...
    render() {
        ...
        return (
            <div className="users-container">
                ...
                {this.state.isModalEditUserOpened && 
                    <ModalEditUser 
                    isOpen={this.state.isModalEditUserOpened} 
