        ...
        return (
            <div className="doctor-extra-infor-container">
                <div className="content-up">
                    ...
                    <div className="name-clinic"><FormattedMessage id="patient.extra-infor-doctor.name-clinic" />: {extraInfor && extraInfor.nameClinic ? extraInfor.nameClinic : ''}</div>
                    <div className="detail-address"><FormattedMessage id="patient.extra-infor-doctor.address-clinic" />: {extraInfor && extraInfor.addressClinic ? extraInfor.addressClinic : ''}</div>
                </div>
...

                    {
                        ...
                        <>
                            ...
                            <div className="detail-infor">
                                ...
                                <div className="note">
                                    <FormattedMessage id="patient.extra-infor-doctor.note" />{extraInfor && extraInfor.note ? extraInfor.note : ''}
                                </div>
                            </div>
