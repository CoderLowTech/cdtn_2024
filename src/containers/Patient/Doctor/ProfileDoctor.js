...
class ProfileDoctor extends Component {
    ...
    render() {
        ...
        let { doctorId, language, isShowDescription, timeData, isShowLinkDetail, isShowPrice } = this.props;
        let nameVi = '', nameEn = '';
        ...
        return (
            <div className="profile-doctor-container">
                ...
                {isShowPrice === true &&
                    <div className="price">
                        <span className="left"><FormattedMessage id="patient.booking-modal.price" />: </span>
